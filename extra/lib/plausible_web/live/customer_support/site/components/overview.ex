    ...
    <div class="mt-8">
      <.form :let={f} for={@form} phx-target={@myself} phx-submit="save-site">
        <div class="flex justify-center items-center gap-x-8 pb-8 mb-8 border-b border-gray-200 dark:border-gray-700 w-full text-sm text-center">
          ...
          <.styled_link new_tab={true} href={Routes.stats_path(PlausibleWeb.Endpoint, :stats, @site.domain, [])}>
            Dashboard
          </.styled_link>

          <.styled_link new_tab={true} href={Routes.site_path(PlausibleWeb.Endpoint, :settings_general, @site.domain, [])}>
            Settings
          </.styled_link>
