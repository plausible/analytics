defmodule Plausible.InstallationSupport.Verification.Errors do
  @moduledoc """
  ...
  @errors %{
    ...
    no_plausible_init_snippet_wp: %{
      message: "We couldn't find the Plausible snippet on your site",
      recommendation:
        "Please insert the snippet into your site. For WordPress sites, we recommend installing and activating our WordPress plugin",
    ...
    unexpected_tracking_script_source: %{
      message: "Plausible script has an unexpected source",
      recommendation:
        "Please check that the snippet on your site matches the one given in installation instructions. It should contain the following: src=\"<%= @expected_tracking_script_src %>\"",
      url:
