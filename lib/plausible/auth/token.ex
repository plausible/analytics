defmodule Plausible.Auth.Token do
  ...
  def verify_login(token) do
    Phoenix.Token.verify(PlausibleWeb.Endpoint, "login", token, max_age: @half_hour_in_seconds)
  end
  ...
  def verify_activation(token) do
    Phoenix.Token.verify(PlausibleWeb.Endpoint, "activation", token, max_age: @half_hour_in_seconds)
  end
end
