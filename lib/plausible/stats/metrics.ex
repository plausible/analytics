defmodule Plausible.Stats.Metrics do
  ...
  defp dashboard_metric_label(:visitors, %Query{input_date_range: :realtime_30m, dimensions: []}, true) do
    "Unique conversions (last 30min)"
  end

  defp dashboard_metric_label(:visitors, %Query{input_date_range: :realtime_30m, dimensions: []}, false) do
  ...
  defp dashboard_metric_label(:pageviews, %Query{input_date_range: :realtime_30m, dimensions: []}, false) do
