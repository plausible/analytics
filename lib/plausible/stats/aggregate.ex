defmodule Plausible.Stats.Aggregate do
  ...
  def aggregate(%{domain: "all"} = site, query, metrics) do
  ...
  defp aggregate_events(%{domain: "all"} = site, query, metrics) do
  ...
  defp aggregate_sessions(%{domain: "all"} = site, query, metrics) do
