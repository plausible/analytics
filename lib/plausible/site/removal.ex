defmodule Plausible.Site.Removal do
  ...
  def run(site) do
    Repo.transaction(fn ->
      ...
      on_ee do
        if Plausible.Sites.regular?(site) and ConsolidatedView.enabled?(site.team) and
             not ConsolidatedView.has_sites_to_consolidate?(site.team) do
          ConsolidatedView.disable(site.team)
        end
