defmodule PlausibleWeb.Components.Google do
  ...
  def button(assigns) do
    ...
    <.unstyled_link
      id={@id}
      href={@to}
      class="inline-flex pr-4 items-center border border-gray-100 shadow-xs rounded-md focus:outline-hidden focus:ring-1 focus:ring-offset-1 focus:ring-gray-200 mt-8 hover:bg-gray-50 dark:hover:bg-gray-700"
    >
      <.logo />
      <span
