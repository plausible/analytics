defmodule PlausibleWeb.Plugs.AuthorizeMCP do
  @moduledoc """
  Authenticates MCP requests via an OAuth Bearer access token.
  ...
  per-tool authorization in the controller.
  ...
  defp rate_limit_config(%{user: user}) do
    {Auth.ApiKey.legacy_limit_key(user), Auth.ApiKey.legacy_hourly_request_limit()}
  end
