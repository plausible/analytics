defmodule PlausibleWeb.Live.Dashboard.ExitPagesDetails do
  @moduledoc """
  Exit pages details modal breakdown component.
  """
  ...
  def render(assigns) do
    ...
    <div>
      <.modal
        id="exit-pages-breakdown-details-modal"
