defmodule PlausibleWeb.Live.Components.ComboBox do
      ...
      <div class="relative w-full">
        ...
        >
          <input
            ...
            phx-debounce={200}
            value={@display_value}
            class="[&.phx-change-loading+svg.spinner]:block border-none py-1 px-1 p-0 w-full inline-block rounded-md focus:outline-none focus:ring-0"
  ...
  def dropdown(assigns) do
    ...
    <ul
      ...
      x-show="isOpen"
      x-ref="suggestions"
      class="w-full dropdown z-50 absolute mt-1 max-h-60 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none bg-gray-900"
    >
      <.option
