defmodule PlausibleWeb.Router do
  ...
  scope "/", PlausibleWeb do
    ...
    delete(
      "/sites/:website/weekly-report/recipients/:recipient",
      SiteController,
    ...
    post(
      "/sites/:website/monthly-report/recipients",
      SiteController,
      :add_monthly_report_recipient
    )

    delete(
      "/sites/:website/monthly-report/recipients/:recipient",
      SiteController,
    ...
    post(
      "/sites/:website/spike-notification/disable",
      SiteController,
      :disable_spike_notification
    )

    put("/sites/:website/spike-notification", SiteController, :update_spike_notification)

    post(
      "/sites/:website/spike-notification/recipients",
      SiteController,
      :add_spike_notification_recipient
    )

    delete(
      "/sites/:website/spike-notification/recipients/:recipient",
      SiteController,
    ...
    put(
      "/:website/settings/features/visibility/:setting",
      SiteController,
    ...
    get(
      "/:website/import/google-analytics/view-id",
      SiteController,
    ...
    get(
      "/:website/import/google-analytics/user-metric",
      SiteController,
