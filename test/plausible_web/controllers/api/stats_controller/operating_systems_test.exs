defmodule PlausibleWeb.Api.StatsController.OperatingSystemsTest do
  ...
  describe "GET /api/stats/:domain/operating_systems" do
    ...
    test "returns operating systems by new visitors", %{conn: conn, site: site} do
      create_pageviews([
        %{domain: site.domain, operating_system: "Mac", timestamp: ~N[2019-01-01 01:00:00]},
        %{domain: site.domain, operating_system: "Mac", timestamp: ~N[2019-01-01 02:00:00]},
        %{domain: site.domain, operating_system: "Android", timestamp: ~N[2019-01-01 02:00:00]}
      ])
