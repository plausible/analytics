defmodule PlausibleWeb.Api.StatsController.OperatingSystemsTest do
  ...
  describe "GET /api/stats/:domain/operating_systems" do
    ...
    test "returns operating systems by new visitors", %{conn: conn, site: site} do
      insert(:pageview, site_id: site.domain, operating_system: "Mac", new_visitor: true, timestamp: ~N[2019-01-01 01:00:00])
      insert(:pageview, site_id: site.domain, operating_system: "Mac", new_visitor: true, timestamp: ~N[2019-01-01 02:00:00])
      insert(:pageview, site_id: site.domain, operating_system: "Android", new_visitor: true, timestamp: ~N[2019-01-01 02:00:00])
