defmodule PlausibleWeb.Api.StatsController.BrowsersTest do
  ...
  describe "GET /api/stats/:domain/browsers" do
    ...
    test "returns top browsers by new visitors", %{conn: conn, site: site} do
      insert(:pageview, site_id: site.domain, browser: "Chrome", new_visitor: true, timestamp: ~N[2019-01-01 01:00:00])
      insert(:pageview, site_id: site.domain, browser: "Chrome", new_visitor: true, timestamp: ~N[2019-01-01 02:00:00])
      insert(:pageview, site_id: site.domain, browser: "Firefox", new_visitor: true, timestamp: ~N[2019-01-01 02:00:00])
