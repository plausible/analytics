defmodule PlausibleWeb.Api.StatsController.BrowsersTest do
  ...
  describe "GET /api/stats/:domain/browsers" do
    ...
    test "returns top browsers by new visitors", %{conn: conn, site: site} do
      create_pageviews([
        %{domain: site.domain, browser: "Chrome", timestamp: ~N[2019-01-01 01:00:00]},
        %{domain: site.domain, browser: "Chrome", timestamp: ~N[2019-01-01 02:00:00]},
        %{domain: site.domain, browser: "Firefox", timestamp: ~N[2019-01-01 02:00:00]}
      ])
