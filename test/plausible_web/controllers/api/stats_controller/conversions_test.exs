defmodule PlausibleWeb.Api.StatsController.ConversionsTest do
  ...
  describe "GET /api/stats/:domain/conversions" do
    ...
    test "returns custom event conversions", %{conn: conn, site: site} do
      ...
      insert(:event, name: "Register", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:event, name: "Register", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:event, name: "Newsletter signup", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:event, name: "Irrelevant", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
    ...
    test "returns pageview conversions", %{conn: conn, site: site} do
      ...
      insert(:pageview, pathname: "/success", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:pageview, pathname: "/success", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:pageview, pathname: "/register", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:pageview, pathname: "/irrelevant", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
    ...
    test "returns mixed conversions in ordered by count", %{conn: conn, site: site} do
      ...
      insert(:event, name: "Signup", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:event, name: "pageview", pathname: "/success", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
      insert(:event, name: "pageview", pathname: "/success", site_id: site.domain, timestamp: ~N[2019-01-01 01:00:00])
