defmodule PlausibleWeb.Api.StatsController.ScreenSizesTest do
  ...
  describe "GET /api/stats/:domain/browsers" do
    ...
    test "returns screen sizes by new visitors", %{conn: conn, site: site} do
      insert(:pageview, domain: site.domain, screen_size: "Desktop", timestamp: ~N[2019-01-01 01:00:00])
      insert(:pageview, domain: site.domain, screen_size: "Desktop", timestamp: ~N[2019-01-01 02:00:00])
      insert(:pageview, domain: site.domain, screen_size: "Mobile", timestamp: ~N[2019-01-01 02:00:00])
