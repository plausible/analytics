defmodule PlausibleWeb.Api.StatsController.SourcesTest do
  ...
  describe "GET /api/stats/:domain/sources" do
    ...
    test "returns top sources filtered by custom pageview props", %{conn: conn, site: site} do
      populate_stats(site, [
        build(:pageview,
          referrer_source: "DuckDuckGo",
          referrer: "duckduckgo.com",
      ...
      conn = get(conn, "/api/stats/#{site.domain}/sources?period=day&date=2021-01-01&filters=#{filters}")
