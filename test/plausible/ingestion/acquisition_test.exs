defmodule Plausible.Ingestion.AcquisitionTest do
  ...
  @static_tests [
    ...
    %{referrer_source: "X (Twitter)", utm_source: "twitter", expected: "Organic Social"},
    ...
    %{referrer_source: "X (Twitter)", utm_source: "twitter-ads", expected: "Paid Social"},
    %{referrer_source: "Reddit", expected: "Organic Social"},
    %{referrer_source: "Perplexity", expected: "AI Assistants"},
