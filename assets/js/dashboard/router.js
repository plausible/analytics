...
import { FilterKeybindsWrapped, KeybindsContextProvider } from './keybinding';
  ...
  return (
    <BrowserRouter basename={site.shared ? `/share/${encodeURIComponent(site.domain)}` : encodeURIComponent(site.domain)}>
      <KeybindsContextProvider>
        <QueryContextProvider site={site}>
          <Route path="/">
            <ScrollToTop />
            <Route path="/" exact><FilterKeybindsWrapped site={site} /></Route>
