...
class ReferrerDrilldownModal extends React.Component {
  ...
  renderTweet(tweet, index) {
    ...
    const border =
      index === 0 ? '' : ' pt-4 border-t border-gray-300 dark:border-gray-500';
    ...
    return (
      <div key={tweet.tweet_id}>
        ...
        <div
          className="my-2 cursor-text tweet-text whitespace-pre-wrap"
    ...
    if (referrer.tweets) {
      return (
        <tr className="text-sm dark:text-gray-200" key={referrer.name}>
          ...
          <td className="p-2 w-32 font-medium" align="right" valign="top">
