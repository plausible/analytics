...
class AllSources extends React.Component {
          ...
          >
            ...
            >
              <img
                ...
                className="inline h-4 w-4 mr-2 align-middle -mt-px"
              />
              {referrer.name}
            </Link>
          </span>
  ...
  render() {
    return (
      <div
        className="stats-item relative bg-white dark:bg-gray-825 shadow-xl rounded p-4"
        style={{ height: '436px' }}
      >
        {this.state.loading && (
  ...
  renderTabs() {
    ...
    return (
      <ul className="flex font-medium text-xs text-gray-500 dark:text-gray-400 space-x-2">
        ...
        <li
          className={
            this.state.tab === 'utm_medium' ? activeClass : defaultClass
          }
        ...
        <li
          className={
            this.state.tab === 'utm_source' ? activeClass : defaultClass
          }
        ...
        <li
          className={
            this.state.tab === 'utm_campaign' ? activeClass : defaultClass
          }
