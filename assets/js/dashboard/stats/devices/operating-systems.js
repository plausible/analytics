...
export default class OperatingSystems extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.timer)
      this.props.timer.onTick(this.fetchOperatingSystems.bind(this));
  }
  ...
  fetchOperatingSystems() {
    if (this.props.query.filters.os) {
      api
        ...
        .then((res) =>
          this.setState({ loading: false, operatingSystems: res })
        );
    } else {
      api
        .get(
