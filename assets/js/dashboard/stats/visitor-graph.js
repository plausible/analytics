  ...
  downloadLink() {
    ...
    return (
      <a href={endpoint} download>
        <svg className="absolute w-4 h-5 text-gray-700 feather dark:text-gray-300 -top-8 right-8 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
      </a>
    )
  }
...
export default withComparisonConsumer(VisitorGraph)
